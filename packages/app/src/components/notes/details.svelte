<script lang="ts">
	...
	import { getNoteMetadataParams } from '@haptic/core/adapter';
	...
	import type { NoteMetadataParams } from '@haptic/core/types';
	import { formatFileSize, formatTimeAgo } from '@haptic/core/utils';
	...
	let tocItems = $derived.by(() =>
		tab === 'toc' && nodeHeadings ? calculateTocItems(nodeHeadings) : []
	);
</script>
